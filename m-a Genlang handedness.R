...
# LOR_SLI <- escalc(measure = 'OR',ai = `SLI Left-Handers`, ci = `SLI Total N` - `SLI Left-Handers`, bi = `TD Left-Handers`, di = `TD Total N`-`TD Left-Handers`, data = read_xlsx('genlang_all_cohorts_updated.xlsx', sheet = 'SLI-All'))
# LOR_SLI <- escalc(measure = 'OR',n1i = `SLI Total N`, n2i = `TD Total N`, x1i = `SLI Left-Handers`, x2i = `TD Left-Handers`, data = read_xlsx('genlang_all_cohorts_updated.xlsx', sheet = 'SLI-All'))
...
# Forest plot ####
forest(meta.LOR_RD, comb.fixed = F, comb.random = T, print.zval = T, print.pval.Q = T, print.I2.ci = T,
       print.tau.ci = T, prediction = F, col.fixed = T, overall = T, smlab = "Left hand Odds Ratio RD", sortvar = OR)
forest(meta.LOR_RD_Male, comb.fixed = F, comb.random = T, print.zval = T, print.pval.Q = T, print.I2.ci = T,
       print.tau.ci = T, prediction = F, overall = T, smlab = "Left hand Odds Ratio RD Male", sortvar = OR)
forest(meta.LOR_RD_Female, comb.fixed = F, comb.random = T, print.zval = T, print.pval.Q = T, print.I2.ci = T,
       print.tau.ci = T, prediction = F, overall = T, smlab = "Left hand Odds Ratio RD Female", sortvar = OR)


forest(meta.LOR_SLI, comb.fixed = F, comb.random = T, print.zval = T, print.pval.Q = T, print.I2.ci = T,
       print.tau.ci = T, prediction = F, overall = T, smlab = "Left hand Odds Ratio DLD", sortvar = OR)
forest(meta.LOR_SLI_Female, comb.fixed = F, comb.random = T, print.zval = T, print.pval.Q = T, print.I2.ci = T,
       print.tau.ci = T, prediction = F, overall = T, smlab = "Left hand OR DLD Females", sortvar = OR)
forest(meta.LOR_SLI_Male, comb.fixed = F, comb.random = T, print.zval = T, print.pval.Q = T, print.I2.ci = T,
       print.tau.ci = T, prediction = F, overall = T, smlab = "Left hand OR DLD Males", sortvar = OR)


forest(meta.LOR_COMBINED, comb.fixed = F, comb.random = T, print.zval = F, print.pval.Q = T, print.I2.ci = T,
       prediction = F, overall = T, smlab = "All", sortvar = OR)
forest(meta.LOR_COMBINED_Male, comb.fixed = F, comb.random = T, print.stat = T, print.pval.Q = T, print.I2.ci = T,
       print.tau.ci = T, prediction = F, overall = T, smlab = "Males", sortvar = OR)
forest(meta.LOR_COMBINED_Female, comb.fixed = F, comb.random = T, print.zval = T, print.pval.Q = T, print.I2.ci = T,
       print.tau.ci = T, prediction = F, overall = T, smlab = "Females", sortvar = OR)


# Funnel plots ####
funnel(meta.LOR_RD, comb.fixed = F,backtransf = F, title = "Funnel plot of Standard Error by Log odds ratio Left Hand RD", studlab = T )
...
funnel(meta.LOR_COMBINED, comb.fixed = F,backtransf = F, title = "Funnel plot of Standard Error by Log odds ratio Left Hand SLI", studlab = T, cex.studlab = 0.6, pos.studlab = '3', cex = 0.8)
